...
Beim ersten Öffnen fragt PhpStorm oft, ob es Composer-Abhängigkeiten indexieren soll. Sage ja - dadurch kennt die IDE die Pakete aus `backend/composer.json` (etwa nyholm/psr7, monolog) und kann sinnvoll ergänzen.
